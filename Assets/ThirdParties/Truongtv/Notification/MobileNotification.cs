...
#region Private
        ...
        public void SetLuckySpinReminder()
        {
            ...
            var data = new[]
            {
                ...
                "☀ Today is a beautiful day, Master has just sent you a lucky spin, take a chance to check it out ️🎈"
            };
        ...
        public void DailyRewardResetReminder(bool receive)
        {
            ...
            var data = new[]
            {
                ...
                "☀️ Today is a beautiful day, Master has just sent you a special gift, take a chance to check it out ️🎈"
            };
